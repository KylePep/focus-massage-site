<template>
  <svg fill="currentColor" width="100%" height="100%" version="1.2" baseProfile="tiny" id="Layer_1"
    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 256 256"
    xml:space="preserve">
    <path id="XMLID_3_"
      d="M204.4,146.7c-3.4-10.2,2.1-21.2,12.3-24.7c10.2-3.4,21.3,2,24.7,12.2c3.4,10.2-2.1,21.3-12.3,24.7
