...
<template>
  <section v-if="page == 'Home'"
    class="relative grid grid-cols-2 min-h-screen bg-white lg:text-xl text-fm-blue leading-tight duration-1000 py-16 px-4">
    ...
    <div
      ...
      <div>
        <RouterLink :to="{ name: 'About' }" class="bg-fm-orange text-white px-6 py-2 rounded-sm">
          About Us
        </RouterLink>
      </div>
    </div>
